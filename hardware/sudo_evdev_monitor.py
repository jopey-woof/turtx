#!/usr/bin/env python3
"""
🐢 Sudo EVDEV TEMPerHUM Monitor
================================
Uses sudo to access input devices and capture sensor data.
Run with: sudo python3 sudo_evdev_monitor.py
"""
...
class SudoEvdevMonitor:
                ...
                if event.type == ecodes.EV_KEY:
                    ...
                    if key_event.keystate == key_event.key_down:
                        ...
                        if char:
                            ...
                            print(f"🔤 {sensor['name']} key: {key_event.keycode} -> '{char}'")
                            ...
                            if char == '\n':
                                ...
                                if line:
                                    print(f"📝 {sensor['name']} complete line: '{line}'")
    ...
    def display_status(self):
        ...
        os.system('clear')
        print("🐢 Sudo EVDEV TEMPerHUM Monitor")
        print("=" * 50)
...
def main():
    ...
    if os.geteuid() != 0:
        ...
        print("Run: sudo python3 sudo_evdev_monitor.py")
        sys.exit(1)
        
    monitor = SudoEvdevMonitor()
