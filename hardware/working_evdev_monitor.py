#!/usr/bin/env python3
"""
🐢 Working EVDEV TEMPerHUM Monitor
===================================
Uses evdev to capture data from both TEMPerHUM sensors and distinguish them.
Run with: sudo python3 working_evdev_monitor.py
"""
...
class WorkingEvdevMonitor:
    ...
    def start_monitoring(self):
        ...
        for sensor_id in self.sensors.keys():
            ...
            thread.daemon = True
            self.sensors[sensor_id]['thread'] = thread
            thread.start()
    ...
    def display_status(self):
        ...
        os.system('clear')
        print("🐢 Working EVDEV TEMPerHUM Monitor")
        print("=" * 50)
...
def main():
    ...
    if os.geteuid() != 0:
        ...
        print("Run: sudo python3 working_evdev_monitor.py")
        sys.exit(1)
        
    monitor = WorkingEvdevMonitor()
