class TurtleDashboard {
    ...
    updateStatus() {
        ...
        // Updated temperature thresholds for Fahrenheit (70-85°F optimal, 65-90°F warning)
        this.updateStatusItem('tempStatus', avgTemp, {
            optimal: { min: 70, max: 85, color: 'optimal', text: 'Optimal' },
            warning: { min: 65, max: 90, color: 'warning', text: 'Attention' },
